...
<html lang="en">
  ...
  <meta charset="UTF-8" />
    ...
    />
    <link rel="stylesheet" href="./final/fontawesome.min.css?cd=12993" />
    <link rel="stylesheet" href="./final/index.min.css?cd=12398" />
  </head>
  <body>
    ...
    <div class="container">
      <article class="details-article">
        <h1 class="articleh1"> GoifPadHer project </h1>
        </article>
      ...
      <div class="container">
        ...
        <section class="detailz">
          ...
          <h2 class=" articleh2 mt-5">
              GoifPadHer Projects in Ugwuachara Community Ebonyi Stat
         </h2>
          ...
          <div class="owl-carousel owl-theme">
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba4.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba7.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba8.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba10.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba13.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba12.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                    src="./img/Back to School and Scholarship Project in Abakaliki/Ba16.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="detailz__img">
                  <img
                  src="./img/sokoto orphanage/girl7.jpg"
                    alt=""
                  />
                </div>
              </div>
          ...
          <h2 class=" articleh2 mt-5">
              Goif commemorating the international day of the GIRL child
              at community secondary commercial school; iffiayong;Uruan;Akwa ibom state.
         </h2>
          <h2 class=" articleh3  text-center font-weight-bolder mb-1  ">
           swip to view more images
          </h2>
